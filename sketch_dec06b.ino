...
#define PIN_IR A1 // [3097] 적외선핀 A0번으로 설정
...
#define EMA_ALPHA 0.35     // EMA alpha by Park

// PID parameters
#define _KP 0.9 //[0711] 비례이득
#define _KD 11
...
Servo myservo;
// global variables
const float coE[] = {0.0000047, 0.0061183, -0.4912427, 114.4093900};
// Distance sensor
...
////////////////////
  ...
  // duty_target = f(duty_neutral, control)
    duty_target = constrain(_DUTY_NEU, 1545,1555);
  ...
  if(event_servo) {
    ...
    myservo.writeMicroseconds(1550-(control)); // [1615]
    delay(3);
